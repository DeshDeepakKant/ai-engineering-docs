...
| :--- | :--- | :--- | :--- |
| **01** | **[Production Backend, Pydantic & Docker](/docs/category/module-1-production-backend--docker)** | FastAPI, REST, Pydantic v2, Docker, AWS EC2 | 13 Videos |
| **02** | **[LCEL, Local LLMs & Tool Calling](/docs/category/module-2-lcel-local-llms--tool-calling)** | LangChain LCEL, Ollama, Groq, AstraDB, ObjectBox, Pinecone | 38 Videos |
| **03** | **[Advanced RAG, Memory & Vector Search](/docs/category/module-3-advanced-rag--memory)** | CRAG, Self-RAG, Memory architectures, Multi-modal RAG | 15 Videos |
| **04** | **[Agentic AI, LangGraph & Multi-Agents](/docs/category/module-4-agentic-ai--langgraph)** | LangGraph, Checkpointers, HITL, CrewAI, Phidata, SmolAgents | 45 Videos |
| **05** | **[Model Context Protocol & Claude Code](/docs/category/module-5-mcp--claude-code)** | MCP Servers/Clients, Claude Code CLI, SubAgents, Plugins | 27 Videos |
| **06** | **[LLM Evaluation & Observability](/docs/category/module-6-llm-evaluation--observability)** | DeepEval, Ragas, RAG Triad, Toxicity testing, LangSmith | 16 Videos |
| **07** | **[Cloud AI, Bedrock & LoRA Fine-Tuning](/docs/category/module-7-cloud-ai--lora-fine-tuning)** | AWS Bedrock, SageMaker, PEFT, LoRA/QLoRA Fine-Tuning | 15 Videos |
