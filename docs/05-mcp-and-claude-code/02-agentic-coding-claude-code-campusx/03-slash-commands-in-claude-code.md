---
id: 03-slash-commands-in-claude-code
title: "Slash Commands in Claude Code"
sidebar_label: "03. Slash Commands in Claude Code"
sidebar_position: 3
description: "Slash Commands in Claude Code - Architectural deep dive, implementation patterns, and enterprise best practices."
tags:
  - mcp
  - claude-code
  - developer-tools
...
<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    ...
    <div><strong>Duration:</strong> 1888</div>
    <div><strong>Course:</strong> Module 5: MCP & Claude Code</div>
    <div><strong>Watch Link:</strong> <a href="https://www.youtube.com/watch?v=eW9FADWxS1k" target="_blank" rel="noopener noreferrer">YouTube Lecture ↗</a></div>
  </div>
</div>
