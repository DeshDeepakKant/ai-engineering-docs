---
id: 03-llms-dont-have-memory-so-how-do-they-rem
title: "LLMs Don’t Have Memory — So How Do They Remember?"
sidebar_label: "03. LLMs Don’t Have Memory — So How Do They Remem"
sidebar_position: 3
description: "Study guide and architectural notes for LLMs Don’t Have Memory — So How Do They Remember? (Memory in LLMs (CampusX))."
tags:
  - campusx
...
<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    ...
    <div><strong>Duration:</strong> 57m 44s</div>
    <div><strong>Playlist:</strong> Memory in LLMs (CampusX)</div>
    <div><strong>Watch Link:</strong> <a href="https://www.youtube.com/watch?v=DcPKJrOF9Wo" target="_blank" rel="noopener noreferrer">YouTube Lecture ↗</a></div>
  </div>
</div>

## 📌 Executive Summary & Learning Objectives

This lecture covers **LLMs Don’t Have Memory — So How Do They Remember?**, focusing on production implementations, edge cases, and industry standards:
...
In modern production AI engineering, **LLMs Don’t Have Memory — So How Do They Remember?** is essential for ensuring reliability, low latency, and deterministic outcomes. As AI systems evolve from naive prompt-in / completion-out scripts into distributed systems, engineers must handle:
...
When deploying LLMs Don’t Have Memory — So How Do They Remember? in enterprise environments, always configure automated retries with exponential backoff and telemetry tracing (such as OpenTelemetry or LangSmith).
:::
...
| **00:15:32** | कॉन्टेक्स्ट विंडो के बारे में क्यों... |
| **00:30:10** | आईडी के अगेंस्ट जो भी मैसेजेस डेटाबेस... |
| **00:44:43** | बेटर तरीके से एक्ट कर पाता है। ठीक है?... |
| **00:57:42** | नेक्स्ट वीडियो में। बाय।... |
