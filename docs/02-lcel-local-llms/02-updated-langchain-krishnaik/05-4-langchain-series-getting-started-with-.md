---
id: 05-4-langchain-series-getting-started-with-
title: "Langchain Series-Getting Started With RAG Pipeline Using Langchain Chromadb And FAISS"
sidebar_label: "05. Langchain Series-Getting Started Wi..."
sidebar_position: 5
description: "Langchain Series-Getting Started With RAG Pipeline Using Langchain Chromadb And FAISS - Architectural deep dive, implementation patterns, and enterprise best practices."
tags:
  - langchain
  - lcel
  - python
...
# 📹 Langchain Series-Getting Started With RAG Pipeline Using Langchain Chromadb And FAISS

<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    <div><strong>Instructor:</strong> Krish Naik</div>
    <div><strong>Duration:</strong> 1821</div>
    <div><strong>Course:</strong> Module 2: LCEL, Local LLMs & Tool Calling</div>
    <div><strong>Watch Link:</strong> <a href="https://www.youtube.com/watch?v=9Thc6hRw2Gs" target="_blank" rel="noopener noreferrer">YouTube Lecture ↗</a></div>
  </div>
</div>
