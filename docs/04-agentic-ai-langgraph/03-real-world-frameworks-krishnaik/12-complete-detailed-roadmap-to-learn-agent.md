---
id: 12-complete-detailed-roadmap-to-learn-agent
title: "Complete Detailed Roadmap To Learn Agentic AI With Free Videos And Materials"
sidebar_label: "12. Complete Detailed Roadmap To Learn ..."
sidebar_position: 12
description: "Complete Detailed Roadmap To Learn Agentic AI With Free Videos And Materials - Architectural deep dive, implementation patterns, and enterprise best practices."
tags:
  - agentic-ai
  - langgraph
  - agents
...
# 📹 Complete Detailed Roadmap To Learn Agentic AI With Free Videos And Materials

<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    <div><strong>Instructor:</strong> Krish Naik</div>
    <div><strong>Duration:</strong> 593</div>
    <div><strong>Course:</strong> Module 4: Agentic AI & LangGraph</div>
    <div><strong>Watch Link:</strong> <a href="https://www.youtube.com/watch?v=F9LGHxDHUlU" target="_blank" rel="noopener noreferrer">YouTube Lecture ↗</a></div>
  </div>
</div>
