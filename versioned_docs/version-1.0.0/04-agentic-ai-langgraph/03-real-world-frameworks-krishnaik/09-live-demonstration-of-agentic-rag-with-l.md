...
title: "Live demonstration of Agentic RAG with Langgraphh"
sidebar_label: "09. Live demonstration of Agentic RAG w..."
sidebar_position: 9
description: "Live demonstration of Agentic RAG with Langgraphh - Architectural deep dive, implementation patterns, and enterprise best practices."
tags:
  - agentic-ai
  - langgraph
  - agents
...
# 📹 Live demonstration of Agentic RAG with Langgraphh

<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    <div><strong>Instructor:</strong> Krish Naik</div>
    <div><strong>Duration:</strong> 8813</div>
