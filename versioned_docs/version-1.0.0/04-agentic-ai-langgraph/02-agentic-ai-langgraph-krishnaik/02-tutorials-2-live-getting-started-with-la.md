---
id: 02-tutorials-2-live-getting-started-with-la
title: "Getting Started With LangGraph For Building AI Agents"
sidebar_label: "02. Getting Started With LangGraph For ..."
sidebar_position: 2
description: "Getting Started With LangGraph For Building AI Agents - Architectural deep dive, implementation patterns, and enterprise best practices."
tags:
  - agentic-ai
  - langgraph
  - agents
...
# 📹 Getting Started With LangGraph For Building AI Agents

<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    <div><strong>Instructor:</strong> Krish Naik</div>
    <div><strong>Duration:</strong> 4139</div>
    <div><strong>Course:</strong> Module 4: Agentic AI & LangGraph</div>
    <div><strong>Watch Link:</strong> <a href="https://www.youtube.com/watch?v=UltwJqpNA04" target="_blank" rel="noopener noreferrer">YouTube Lecture ↗</a></div>
  </div>
</div>
