---
id: 02-generative-ai-vs-agentic-ai-agentic-ai-u
title: "Generative AI vs Agentic AI"
sidebar_label: "02. Generative AI vs Agentic AI"
sidebar_position: 2
description: "Generative AI vs Agentic AI - Architectural deep dive, implementation patterns, and enterprise best practices."
tags:
  - agentic-ai
  - langgraph
  - agents
...
<div className="video-card" style={{border: '1px solid #30363d', borderRadius: '8px', padding: '16px', marginBottom: '24px', background: 'rgba(56, 139, 253, 0.05)'}}>
  <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
    ...
    <div><strong>Duration:</strong> 3764</div>
    <div><strong>Course:</strong> Module 4: Agentic AI & LangGraph</div>
    <div><strong>Watch Link:</strong> <a href="https://www.youtube.com/watch?v=xdA0pGDiUPE" target="_blank" rel="noopener noreferrer">YouTube Lecture ↗</a></div>
  </div>
</div>
